...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td><h3>Members: Home</h3>
				<h4>( MVC )</h4></td>
		</tr>
	</table>

	<p>This is the Home page for Members: Home</p>
	...
	<ul>
		<li><a href='listAllMembers.jsp'>列出所有會員資料</a><br>
		<br></li>
		...
		<li>
			<FORM METHOD="post" ACTION="members.do">
				<b>選擇會員姓名:</b> <select size="1" name="memberId">
					<c:forEach var="membersVO" items="${membersSvc.all}">
						<option value="${membersVO.memberId}">${membersVO.memberName}
					</c:forEach>
				</select> <input type="hidden" name="action" value="getOne_For_Display">
				<input type="submit" value="送出">
			</FORM>
