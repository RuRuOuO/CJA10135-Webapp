...
%>
--<%= membersVO==null %>--${membersVO.memberId}-- <!-- for line 100 -->
...
<table>
	...
	<tr>
		<td>會員姓名:</td>
		<td><input type="TEXT" name="memberName" value="<%=membersVO.getMemberName()%>" size="45"/></td>
	</tr>
	<tr>
		<td>會員生日:</td>
	...
	<tr>
		<td>會員電話:</td>
		<td><input type="TEXT" name="memberPhone" value="<%=membersVO.getMemberPhone()%>" size="45"/></td>
	</tr>
	<tr>
		<td>會員地址:</td>
		<td><input type="TEXT" name="memberAddress" value="<%=membersVO.getMemberAddress()%>" size="45"/></td>
	</tr>
	<tr>
<!-- 		<td>目前照片:</td> -->
...
<input type="hidden" name="memberId" value="<%=membersVO.getMemberId()%>">
...
<script>
        ...
        $('#f_date4').datetimepicker({
           theme: '',              //theme: 'dark',
 	       ...
 	       step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
 	       format:'Y-m-d H:i:s',         //format:'Y-m-d H:i:s',
 		   value: '<%=membersVO.getMemberLastLoginTime()%>', // value:   new Date(),
           //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
           //startDate:	            '2017/07/10',  // 起始日
           //minDate:               '-1970-01-01', // 去除今日(不含)之前
           //maxDate:               '+1970-01-01'  // 去除今日(不含)之後
